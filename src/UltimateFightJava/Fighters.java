...
public class Fighters implements Actions{
    private String name, nationality, category;
    private int age, victories, defeats, ties;
    private float height, weight;

    public Fighters(String name, String nationality, int age, int victories, int defeats, int ties, float height, float weight) {
        this.name = name;
